// Test script for carousel workflow
...
const TEST_LINK = 'https://shopee.co.id/test-product-123456789';

async function testCarouselWorkflow() {
  console.log('🧪 Testing Carousel Workflow\n');
  ...
  try {
    ...
    const telegramId = '123456789'; // Test user
    ...
    // 5. Create test content directly
    ...
    // 6. Execute carousel pipeline
    console.log('\nSTEP 4: Executing carousel pipeline');
    console.log('-'.repeat(30));
    ...
    const tests = [
      ...
      { name: '5 Render Jobs Created', pass: result.renderJobIds.length === 5 },
    ...
    if (passed === tests.length) {
      console.log('\n🎉 ALL TESTS PASSED! Carousel workflow is working correctly.');
    } else {
